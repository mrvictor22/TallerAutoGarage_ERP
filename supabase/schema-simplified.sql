...
CREATE POLICY "Admin and reception can insert owners" ON owners FOR INSERT TO authenticated WITH CHECK (public.user_role() IN ('admin', 'reception'));
CREATE POLICY "Admin and reception can update owners" ON owners FOR UPDATE TO authenticated USING (public.user_role() IN ('admin', 'reception'));
CREATE POLICY "Admins can delete owners" ON owners FOR DELETE TO authenticated USING (public.is_admin());

-- Vehicles policies
CREATE POLICY "Authenticated users can view vehicles" ON vehicles FOR SELECT TO authenticated USING (true);
CREATE POLICY "Admin and reception can insert vehicles" ON vehicles FOR INSERT TO authenticated WITH CHECK (public.user_role() IN ('admin', 'reception'));
CREATE POLICY "Admin and reception can update vehicles" ON vehicles FOR UPDATE TO authenticated USING (public.user_role() IN ('admin', 'reception'));
CREATE POLICY "Admins can delete vehicles" ON vehicles FOR DELETE TO authenticated USING (public.is_admin());

-- Orders policies
CREATE POLICY "Authenticated users can view orders" ON orders FOR SELECT TO authenticated USING (true);
CREATE POLICY "Admin and reception can insert orders" ON orders FOR INSERT TO authenticated WITH CHECK (public.user_role() IN ('admin', 'reception'));
CREATE POLICY "Authenticated users can update orders" ON orders FOR UPDATE TO authenticated USING (true);
CREATE POLICY "Admins can delete orders" ON orders FOR DELETE TO authenticated USING (public.is_admin());
